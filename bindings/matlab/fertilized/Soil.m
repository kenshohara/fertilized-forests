...
classdef Soil
    ...
    methods
        ...
        function [res] = RoughlyBalancedBagging(this, n_classes, n_class_samples, random_seed)
            % Class information:
            % ==================
            % 
            ...
            getter = sprintf('%s%s%s', 'get', 'RoughlyBalancedBagging', tmp);
            ptr = calllib(this.LibName, getter, n_classes, n_class_samples, random_seed);
            res = RoughlyBalancedBagging(this.getDataTypes(), this.LibName, ptr, '%s%s');    
        end
