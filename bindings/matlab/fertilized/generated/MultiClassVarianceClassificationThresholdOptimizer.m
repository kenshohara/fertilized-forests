classdef MultiClassVarianceClassificationThresholdOptimizer < FertilizedObject
    ...
    methods (Access = {?Soil, ?MultiClassVarianceClassificationThresholdOptimizer})
        function this = MultiClassVarianceClassificationThresholdOptimizer(dataTypes, libName, ptr, functionFormat)
            position_list = [1,2,3];
            tmp = '';
            for i = position_list
            ...
            delFuncName = ['delete_MultiClassVarianceClassificationThresholdOptimizer' tmp];
    ...
    methods (Access = public)
        function [res] = eq(this, rhs) 
            ...
            getter = sprintf('%s%s%s', 'eq', 'MultiClassVarianceClassificationThresholdOptimizer', suffix);
