classdef RoughlyBalancedBagging < FertilizedObject
    ...
    methods (Access = {?Soil, ?RoughlyBalancedBagging})
        function this = RoughlyBalancedBagging(dataTypes, libName, ptr, functionFormat)
            ...
            delFuncName = ['delete_RoughlyBalancedBagging' tmp];
    ...
    methods (Access = public)
        function [res] = eq(this, rhs) 
            ...
            getter = sprintf('%s%s%s', 'eq', 'RoughlyBalancedBagging', suffix);
