...
extern "C"
{
    ...
    DllExport mxArray * depthsForest_i_i_uint_fv_fv (void *__instance

);
    DllExport mxArray * depthsForest_f_f_uint_fv_fv (void *__instance

);
    DllExport mxArray * depthsForest_d_d_uint_fv_fv (void *__instance

);
    DllExport mxArray * depthsForest_uint8_uint8_uint_fv_fv (void *__instance
    ...
    DllExport mxArray * depthsForest_d_d_d_rpd_vprpfd (void *__instance
    ...
    DllExport mxArray * compute_feature_importancesForest_i_i_uint_fv_fv (void *__instance

);
    DllExport mxArray * compute_feature_importancesForest_f_f_uint_fv_fv (void *__instance

);
    DllExport mxArray * compute_feature_importancesForest_d_d_uint_fv_fv (void *__instance

);
    DllExport mxArray * compute_feature_importancesForest_uint8_uint8_uint_fv_fv (void *__instance
    ...
    DllExport mxArray * compute_feature_importancesForest_d_d_d_rpd_vprpfd (void *__instance
    ...
    DllExport void * getObjectTemplate_i_i_uint_fv_fv (

        unsigned int example_param
);
    DllExport void * getObjectTemplate_f_f_uint_fv_fv (

        unsigned int example_param
);
    DllExport void delete_ObjectTemplate_i_i_uint_fv_fv(void *ptr);
    DllExport void delete_ObjectTemplate_f_f_uint_fv_fv(void *ptr);
    ...
    DllExport size_t depthTree_i_i_uint_fv_fv (void *__instance

);
    DllExport size_t depthTree_f_f_uint_fv_fv (void *__instance

);
    DllExport size_t depthTree_d_d_uint_fv_fv (void *__instance

);
    DllExport size_t depthTree_uint8_uint8_uint_fv_fv (void *__instance

);
    DllExport size_t depthTree_uint8_int16_uint_fv_fv (void *__instance

);
    DllExport size_t depthTree_uint8_int16_int16_fv_fv (void *__instance
    ...
    DllExport size_t depthTree_d_d_d_rpd_vprpfd (void *__instance
    ...
    DllExport mxArray * compute_feature_importancesTree_i_i_uint_fv_fv (void *__instance

);
    DllExport mxArray * compute_feature_importancesTree_f_f_uint_fv_fv (void *__instance

);
    DllExport mxArray * compute_feature_importancesTree_d_d_uint_fv_fv (void *__instance

);
    DllExport mxArray * compute_feature_importancesTree_uint8_uint8_uint_fv_fv (void *__instance

);
    DllExport mxArray * compute_feature_importancesTree_uint8_int16_uint_fv_fv (void *__instance

);
    DllExport mxArray * compute_feature_importancesTree_uint8_int16_int16_fv_fv (void *__instance
    ...
    DllExport mxArray * compute_feature_importancesTree_d_d_d_rpd_vprpfd (void *__instance
