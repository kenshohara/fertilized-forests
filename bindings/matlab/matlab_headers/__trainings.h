...
extern "C"
{
    ...
    DllExport void * getBoostedTraining_i_i_uint_fv_fv (

        void * boosting_strategy
);
    DllExport void * getBoostedTraining_f_f_uint_fv_fv (

        void * boosting_strategy
);
    DllExport void * getBoostedTraining_d_d_uint_fv_fv (

        void * boosting_strategy
);
    DllExport void * getBoostedTraining_uint8_uint8_uint_fv_fv (

        void * boosting_strategy
);
    DllExport void * getBoostedTraining_uint8_int16_uint_fv_fv (

        void * boosting_strategy
);
    DllExport void * getBoostedTraining_uint8_int16_int16_fv_fv (

        void * boosting_strategy
);


    DllExport int eqBoostedTraining_i_i_uint_fv_fv (void *__instance,

        void * rhs
);
    DllExport int eqBoostedTraining_f_f_uint_fv_fv (void *__instance,

        void * rhs
);
    DllExport int eqBoostedTraining_d_d_uint_fv_fv (void *__instance,

        void * rhs
);
    DllExport int eqBoostedTraining_uint8_uint8_uint_fv_fv (void *__instance,

        void * rhs
);
    DllExport int eqBoostedTraining_uint8_int16_uint_fv_fv (void *__instance,

        void * rhs
);
    DllExport int eqBoostedTraining_uint8_int16_int16_fv_fv (void *__instance,

        void * rhs
);
    DllExport void delete_BoostedTraining_i_i_uint_fv_fv(void *ptr);
    DllExport void delete_BoostedTraining_f_f_uint_fv_fv(void *ptr);
    DllExport void delete_BoostedTraining_d_d_uint_fv_fv(void *ptr);
    DllExport void delete_BoostedTraining_uint8_uint8_uint_fv_fv(void *ptr);
    DllExport void delete_BoostedTraining_uint8_int16_uint_fv_fv(void *ptr);
    DllExport void delete_BoostedTraining_uint8_int16_int16_fv_fv(void *ptr);
    ...
    DllExport void * getClassicTraining_uint8_int16_int16_ht_vht (

        void * bagging_strategy
);
    DllExport void * getClassicTraining_f_f_int16_ht_vht (
    ...
    DllExport int eqClassicTraining_uint8_int16_int16_ht_vht (void *__instance,

        void * rhs
);
    DllExport int eqClassicTraining_f_f_int16_ht_vht (void *__instance,
    ...
    DllExport void delete_ClassicTraining_uint8_int16_int16_ht_vht(void *ptr);
    DllExport void delete_ClassicTraining_f_f_int16_ht_vht(void *ptr);
    ...
    DllExport void delete_ITraining_uint8_int16_int16_ht_vht(void *ptr);
    DllExport void delete_ITraining_f_f_int16_ht_vht(void *ptr);
