...
using namespace fertilized;
          ...
          void * getRoughlyBalancedBagging_d_d_d_rpd_vprpfd (
...
#pragma warning( disable : 4800 )
  ...
  auto *libfunc_result = new std::shared_ptr<RoughlyBalancedBagging<double,double,double,std::pair<std::shared_ptr<std::vector<double>>,std::shared_ptr<std::vector<double>>>,std::vector<std::pair<std::pair<std::shared_ptr<std::vector<double>>,std::shared_ptr<std::vector<double>>>,float>>>>(
...
#pragma warning( pop )
  ...
  return __converted_return_value;
          ...
          int eqRoughlyBalancedBagging_d_d_d_rpd_vprpfd (void *__instance,

        void * rhs
) {
  // Unpack instance.
  auto __instance_unpacked = *static_cast<std::shared_ptr<RoughlyBalancedBagging<double,double,double,std::pair<std::shared_ptr<std::vector<double>>,std::shared_ptr<std::vector<double>>>,std::vector<std::pair<std::pair<std::shared_ptr<std::vector<double>>,std::shared_ptr<std::vector<double>>>,float>>>>*>(__instance);
  // From C types conversions.
...
// Destructor.
void delete_RoughlyBalancedBagging_d_d_d_rpd_vprpfd(void *ptr) {
  auto * storage = static_cast<std::shared_ptr<RoughlyBalancedBagging<double,double,double,std::pair<std::shared_ptr<std::vector<double>>,std::shared_ptr<std::vector<double>>>,std::vector<std::pair<std::pair<std::shared_ptr<std::vector<double>>,std::shared_ptr<std::vector<double>>>,float>>>>*>(ptr);
  delete storage;
}
