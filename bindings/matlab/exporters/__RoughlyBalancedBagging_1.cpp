...
using namespace fertilized;
          ...
          void * getRoughlyBalancedBagging_f_f_uint_fv_fv (
...
#pragma warning( disable : 4800 )
  ...
  auto *libfunc_result = new std::shared_ptr<RoughlyBalancedBagging<float,float,uint,std::vector<float>,std::vector<float>>>(
...
#pragma warning( pop )
  ...
  return __converted_return_value;
          ...
          int eqRoughlyBalancedBagging_f_f_uint_fv_fv (void *__instance,

        void * rhs
) {
  // Unpack instance.
  auto __instance_unpacked = *static_cast<std::shared_ptr<RoughlyBalancedBagging<float,float,uint,std::vector<float>,std::vector<float>>>*>(__instance);
  // From C types conversions.
...
// Destructor.
void delete_RoughlyBalancedBagging_f_f_uint_fv_fv(void *ptr) {
  auto * storage = static_cast<std::shared_ptr<RoughlyBalancedBagging<float,float,uint,std::vector<float>,std::vector<float>>>*>(ptr);
  delete storage;
}
