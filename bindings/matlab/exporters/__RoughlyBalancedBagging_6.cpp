...
using namespace fertilized;
          ...
          void * getRoughlyBalancedBagging_uint8_int16_int16_hp_vhp (
...
#pragma warning( disable : 4800 )
  ...
  auto *libfunc_result = new std::shared_ptr<RoughlyBalancedBagging<uint8_t,int16_t,int16_t,std::pair<float, std::shared_ptr<std::vector<int16_t>>>,std::vector<std::pair<float, std::shared_ptr<std::vector<int16_t>>>>>>(
...
#pragma warning( pop )
  ...
  return __converted_return_value;
          ...
          int eqRoughlyBalancedBagging_uint8_int16_int16_hp_vhp (void *__instance,

        void * rhs
) {
  // Unpack instance.
  auto __instance_unpacked = *static_cast<std::shared_ptr<RoughlyBalancedBagging<uint8_t,int16_t,int16_t,std::pair<float, std::shared_ptr<std::vector<int16_t>>>,std::vector<std::pair<float, std::shared_ptr<std::vector<int16_t>>>>>>*>(__instance);
  // From C types conversions.
...
// Destructor.
void delete_RoughlyBalancedBagging_uint8_int16_int16_hp_vhp(void *ptr) {
  auto * storage = static_cast<std::shared_ptr<RoughlyBalancedBagging<uint8_t,int16_t,int16_t,std::pair<float, std::shared_ptr<std::vector<int16_t>>>,std::vector<std::pair<float, std::shared_ptr<std::vector<int16_t>>>>>>*>(ptr);
  delete storage;
}
